   ...
   <link href="{{ asset('css/admin/font-awesome.css') }}" rel="stylesheet" />
    ...
    <body>
        <div id="loginbox">  
            ...
            <form class="form-vertical" action="{{ route('postDangNhapAdmin') }}" method="post" id="loginform" autocomplete="off">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" placeholder="Email" name="email" required autofocus value="{{ old('email') }}" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input type="password" placeholder="Mật khẩu" name="password" required />
                        </div>
                    </div>
                </div>
