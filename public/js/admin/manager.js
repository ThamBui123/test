...
$(".sanpham_hsx").change(function() {

  var hangsanxuat_id = $(this).select2("val");
  $.ajax({
    url: '../ajax-san-pham-hsx',
    type: 'post',
    data: 'hangsanxuat_id=' + hangsanxuat_id + '&_token=' + token_key,
    // dataType: 'json',
    beforeSend: function() {
